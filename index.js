...
const defaultSettings = {
    ...
    "information": {// 记录当前回复中命令、要求、条款、规则、线索、时效、通知、说明、资料(禁止记录其它类型信息)
        //格式："编号":{"日期":"日期","时间(可选)":"时间","地点":"地点","角色":"相关角色(多人用逗号分隔)","类型":"说明", "主题":"主题","细项":["原文引用1","原文引用2",…],"被参考次数":0}
    } ,
