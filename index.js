...
const defaultSettings = {
    ...
    "故事历程": [ // **只输出当前回复的信息** 简洁清晰地总结客观信息,忽略主观描述,突出事件发展脉络和关键转折点,每句都应**自包含**完整独立的信息。
        // **特殊指导:**
    ...
    "角色卡": {
        "{{角色名}}": {
            ...
            "角色关系": { // [角色关系]：记录角色与其他人的关系和互动模式，会随着互动而缓慢演变。
                // 提供了关系的“质感”和互动模式
                "莉娜": {
                    "关系描述": "一个行走的麻烦制造机，逻辑混乱但直觉惊人，是让人头痛却又不得不在关键时刻依赖的合作伙伴。",
                    "互动模式": "常用尖刻的言语进行讽刺和打击，以掩饰自己下意识的关心和保护欲。在对方真正遇到危险时，会毫不犹豫地出手相助。"
                },
                "导师马库斯": {
                    "关系描述": "如同父亲般的导师，是学术道路上的灯塔和唯一的知己，对其极度尊敬和依赖。",
                    "互动模式": "在他面前会卸下所有防备，展现出谦逊学生的一面，言语中充满敬意，从不质疑其判断。"
                }
            }
        }
        // ... 其他角色
